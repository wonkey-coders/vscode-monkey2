...
suite('Go Extension Tests', () => {
	...
	test('Test Definition Provider using godoc', (done) => {
		let config = Object.create(vscode.workspace.getConfiguration('monkey2'), {
...
`;
	...
	test('Workspace Symbols', (done) => {
		...
		let configWithoutIgnoringFolders = Object.create(vscode.workspace.getConfiguration('monkey2'), {
			'gotoSymbol': {
				value: {
					'ignoreFolders': []
				}
		...
		let configWithIgnoringFolders = Object.create(vscode.workspace.getConfiguration('monkey2'), {
			'gotoSymbol': {
				value: {
